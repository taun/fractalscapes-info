...
COPY . /fractalscapes-info

# Use Hugo to build the static site files.
RUN hugo -v --source=/hugo-site --destination=/fractalsccapes-info/public
...
COPY --from=HUGOINSTALL /fractalscapes-info/public/ /usr/share/nginx/html/
